...
namespace CrossingLears.Editor
{
    public class GeneralTab : CL_WindowTab
    {
        ...
        private void WebsiteAndFeedbackSection()
        {
            ...
            EditorGUILayout.HelpBox("Sending feedback transmits only the text you type below to the Crossing Lears publisher endpoint. Nothing is sent automatically on import or load.", MessageType.Info);
