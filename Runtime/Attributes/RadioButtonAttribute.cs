...
#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof(RadioAttribute), true)]
    public class RadioDrawer : PropertyDrawer
    {
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            RadioAttribute radioAttribute = (RadioAttribute)attribute;
        ...
        private void DrawBoolean(Rect position, SerializedProperty property, GUIContent label, RadioAttribute radioAttribute)
        {
        ...
        private void DrawInt(Rect position, SerializedProperty property, GUIContent label, RadioAttribute radioAttribute)
        {
