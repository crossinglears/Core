...
namespace CrossingLears
{
    public static class ObjectExtensions
    {
        ...
        public static void open(this IEnumerable<Component> gameObjects)
        {
            foreach (Component go in gameObjects)
            {
                if(go != null)
        ...
        public static void close(this IEnumerable<Component> gameObjects)
        {
            foreach (Component go in gameObjects)
            {
                if(go != null)
